...
type ChildUserDropdownProps = {
  /** When true, always show name/grade (e.g. hamburger drawer). */
  showLabel?: boolean;
...
export default function ChildUserDropdown({
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div
          className={`absolute left-0 right-0 w-full min-w-[200px] rounded-[12px] overflow-hidden z-[70] shadow-lg ${
