...
type ClassMediaControlsProps = {
  ...
  onToggleCamera: () => void;
  onEndCall: () => void;
  /** Compact overlay for avatar card / board corner. */
  variant?: "bar" | "overlay";
};
...
export default function ClassMediaControls({
  ...
  return (
    ...
    >
      ...
      >
        {micEnabled ? (
          <svg width={compact ? 18 : 20} height={compact ? 18 : 20} viewBox="0 0 24 24" fill="none" stroke={stroke} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <svg width={compact ? 18 : 20} height={compact ? 18 : 20} viewBox="0 0 24 24" fill="none" stroke="#FF7B7B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <ControlButton compact={compact} danger onClick={onEndCall} label="Leave class">
        <svg width={compact ? 18 : 22} height={compact ? 18 : 22} viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
