...
const contacts = [
  ...
  { name: "Mom", time: "10:45am", message: "Don't forget your lunch today!", avatar: "/assets/wayfinder Em.png", unread: 0, active: false },
  { name: "Fatima's Dad", time: "9:30am", message: "Thank you for the update on Fatima.", avatar: "/assets/wayfinder Em.png", unread: 0, active: false },
  { name: "Bloom Buddy", time: "Yesterday", message: "I feel good today! 🌱", avatar: "/assets/wayfinder-symbol.png", unread: 2, active: false },
  { name: "Ali's Mom", time: "Yesterday", message: "How is Ali doing in reading?", avatar: "/assets/wayfinder Em.png", unread: 0, active: false },
];

const chatMessages = [
  { sender: "Mom", avatar: "/assets/wayfinder Em.png", text: "Alex, how's your 4th Grade English going? What did you learn today?", isUser: false, role: "mom" },
  { sender: "You", text: "Hi Mom! I learned about main ideas and new vocabulary words.", isUser: true, role: "user" },
  { sender: "Wayfinder", avatar: "/assets/wayfinder-symbol.png", text: "That sounds great! Alex did very well today. Do you remember the main idea of the story?", isUser: false, role: "wayfinder" },
  { sender: "You", text: 'The main idea was about a magical garden. My favorite new word is "gleaming"!', isUser: true, role: "user" },
  { sender: "Mom", avatar: "/assets/wayfinder Em.png", text: "That's wonderful! I'm so proud of you. Keep up the great work!", isUser: false, role: "mom" },
  { sender: "Wayfinder", avatar: "/assets/wayfinder-symbol.png", text: "Alex has been making excellent progress in vocabulary this week. Reading confidence is improving steadily.", isUser: false, role: "wayfinder" },
  { sender: "You", text: "Thanks Wayfinder! Can we practice more vocabulary tomorrow?", isUser: true, role: "user" },
  { sender: "Wayfinder", avatar: "/assets/wayfinder-symbol.png", text: "Absolutely! I'll prepare some fun word games for our next session. See you tomorrow! 🌟", isUser: false, role: "wayfinder" },
];
        ...
        <div className="flex-1 flex flex-col">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between px-4 md:px-5 py-3 md:py-3.5 border-b border-white/10 gap-2">
            <div>
              ...
              <p style={{ ...inter, fontWeight: 400, fontSize: "13px", lineHeight: "18px", color: "rgba(255,255,255,0.5)" }}>Wayfinder, Mom, Alex</p>
            </div>
            ...
            {chatMessages.map((msg, i) => (
              <div key={i} className={`flex ${msg.isUser ? "justify-end" : "justify-start"} gap-2`}>
                ...
                <div className={`max-w-[85%] md:max-w-[420px] ${msg.isUser ? "items-end" : "items-start"} flex flex-col`}>
                  {!msg.isUser && (
                    <span className="rounded-full px-2.5 py-0.5 mb-1" style={{ ...inter, fontWeight: 600, fontSize: "11px", lineHeight: "16px", color: "#FFFFFF", backgroundColor: "#00CED1" }}>{msg.sender}</span>
                  )}
