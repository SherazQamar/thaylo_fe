    ...
    <div className="p-4 md:p-6 lg:p-10 overflow-y-auto">
      ...
      <div className="rounded-[12px] p-4 md:p-6 mb-6" style={{ backgroundColor: "#313044" }}>
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <span className="rounded-[30px] border border-[#F59E0B] flex-shrink-0 self-center md:self-auto" style={{ ...inter, fontWeight: 500, fontSize: "14px", lineHeight: "20px", color: "#F59E0B", padding: "8px 18px" }}>
            Risk: Amber
          </span>
        </div>
      </div>
