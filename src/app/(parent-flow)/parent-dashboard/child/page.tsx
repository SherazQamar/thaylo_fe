  ...
  return (
    <div className="p-4 md:p-6 lg:p-10 overflow-y-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-4">
              ...
              {[
                ...
                <div key={i}>
                  ...
                  <div className="w-full h-2 rounded-full bg-[#525162]">
                    <div className="h-full rounded-full" style={{ width: `${skill.value}%`, backgroundColor: "#00CED1" }} />
                  </div>
                </div>
              ))}
            </div>
        ...
        {/* Right Column */}
        <div className="flex flex-col gap-4 min-w-0 lg:min-w-[280px]">
          {/* Growth Garden */}
          <div className="rounded-[12px] p-6 flex flex-col items-center justify-center" style={{ backgroundColor: "#313044" }}>
            <h3 style={{ ...inter, fontWeight: 600, fontSize: "18px", lineHeight: "28px", color: "#FFFFFF", marginBottom: "16px" }}>Growth Garden</h3>
            <p style={{ ...inter, fontWeight: 700, fontSize: "22px", lineHeight: "28px", color: "#FFFFFF", marginBottom: "12px" }}>Stage 3</p>
            <div className="w-[120px] h-[120px] rounded-full border-4 border-[#525162] flex items-center justify-center mb-4 relative">
              <div className="w-[100px] h-[100px] rounded-full border-4 border-[#00CED1] flex items-center justify-center" style={{ borderTopColor: "transparent" }}>
          ...
          <div className="rounded-[12px] p-4 md:p-5" style={{ backgroundColor: "#313044" }}>
            <div className="flex items-center justify-between mb-4">
              ...
              <Link href="/parent-dashboard/message" className="uppercase cursor-pointer hover:opacity-80 transition-opacity" style={{ ...inter, fontWeight: 700, fontSize: "13.5px", lineHeight: "18px", letterSpacing: "0.8px", color: "#00CED1" }}>Open Chat</Link>
            </div>
